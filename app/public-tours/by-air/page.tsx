              ...
              >
                ...
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4 bg-white px-3 py-1 rounded-full flex items-center gap-1">
                    ...
                    <span className="text-xs font-medium text-emerald-600">By Air</span>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-emerald-600 mb-2">Save Time</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-emerald-600 mb-2">Aerial Views</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-emerald-600 mb-2">Comfort</h3>
              <p className="text-gray-600">
