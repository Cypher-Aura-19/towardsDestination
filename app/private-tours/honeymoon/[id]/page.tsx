      ...
      <div className="max-w-7xl mx-auto px-6 pt-6 pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Contact Section */}
            <section className="py-16 bg-gradient-to-br from-red-50 via-white to-red-50 rounded-xl">
              <div className="px-4 sm:px-8 max-w-2xl mx-auto">
                {/* Send Message Button */}
                <div className="text-center mb-8">
                  <button
                    onClick={handleWhatsAppInquiry}
                    className="w-full sm:w-auto bg-red-800 hover:bg-red-900 text-white px-8 py-4 rounded-lg font-bold text-lg transition-colors shadow-lg hover:shadow-xl inline-flex items-center justify-center gap-2"
                  >
                    <Send className="w-5 h-5" />
                    Send Message
                  </button>
                ...
                {/* Our Contact Card */}
                <div className="bg-red-100 rounded-2xl p-6 sm:p-8 shadow-lg border border-red-200 mb-8">
                  <h2 className="text-3xl font-bold text-red-800 mb-6 text-center">Our Contact</h2>
                  ...
                  <div className="text-center mb-6">
                    ...
                    <p className="text-gray-800 font-semibold mb-2 text-lg">Phone</p>
                    <a href="tel:+923174101300" className="text-red-700 hover:text-red-800 underline font-medium block">
                      +92 317 4101300
                    </a>
                    <a href="https://wa.me/923153309070" target="_blank" rel="noopener noreferrer" className="text-red-700 hover:text-red-800 underline font-medium block mt-1">
                  ...
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-800 font-semibold mb-2 text-lg">Email Address</p>
                    <a href="mailto:Info.Towardsdestination@gmail.com" className="text-red-700 hover:text-red-800 underline font-medium break-all">
                  ...
                  <div className="text-center">
                    ...
                    <div className="flex items-center justify-center gap-4">
                      <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-14 h-14 bg-red-600 hover:bg-red-700 rounded-full flex items-center justify-center transition-colors shadow-md hover:shadow-lg">
                        <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                        </svg>
                      </a>
                      <a href="https://www.instagram.com/towardsdestination.pk" target="_blank" rel="noopener noreferrer" className="w-14 h-14 bg-red-600 hover:bg-red-700 rounded-full flex items-center justify-center transition-colors shadow-md hover:shadow-lg">
                        <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="w-14 h-14 bg-red-600 hover:bg-red-700 rounded-full flex items-center justify-center transition-colors shadow-md hover:shadow-lg">
                        <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg border border-red-200">
                  <h2 className="text-3xl font-bold text-red-800 mb-6 text-center">Where to Find Us</h2>
                  
                  <div className="text-center space-y-4">
                    <div>
                      <p className="text-red-700 font-bold text-lg mb-3">Islamabad Office (Main Head Office)</p>
                      <a href="https://maps.app.goo.gl/rNE3RXtnzyVFKpqC7?g_st=ic" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-red-700 transition-colors block text-sm sm:text-base">
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      ...
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <a href="mailto:Info.Towardsdestination@gmail.com" className="text-red-700 hover:text-red-800 underline font-medium text-sm sm:text-base break-all">
                          Info.Towardsdestination@gmail.com
                        </a>
                      </div>
                    </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-white rounded-2xl shadow-xl border border-red-200 overflow-hidden">
              <div className="p-6 bg-red-50 border-b border-red-200">
                <div className="text-sm text-gray-600 mb-1">Honeymoon Package</div>
                <div className="text-2xl font-bold text-red-700">{pkg.price}</div>
                <p className="text-sm text-gray-600 mt-2">Customizable for couples</p>
              </div>
