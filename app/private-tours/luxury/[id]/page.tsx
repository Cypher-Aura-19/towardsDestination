      ...
      <div className="max-w-7xl mx-auto px-6 pt-6 pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Contact Section */}
            <section className="bg-gradient-to-br from-amber-50 via-white to-yellow-50 rounded-xl p-8 border border-amber-200">
              <h2 className="text-3xl font-bold text-amber-800 mb-6">Contact Us</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+923174101300" className="text-amber-700 hover:text-amber-800 underline font-medium">
                      +92 317 4101300
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:Info.Towardsdestination@gmail.com" className="text-amber-700 hover:text-amber-800 underline font-medium">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-white rounded-2xl shadow-xl border border-amber-200 overflow-hidden">
              <div className="p-6 bg-gradient-to-br from-amber-50 to-yellow-50 border-b border-amber-200">
                <div className="text-sm text-gray-600 mb-1">Luxury Package</div>
                <div className="text-2xl font-bold text-amber-700">{pkg.price}</div>
                <p className="text-sm text-gray-600 mt-2">Premium experience included</p>
