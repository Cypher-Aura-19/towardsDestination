        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-emerald-600 mb-2">Flights</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-emerald-600 mb-2">Accommodation</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-emerald-600 mb-2">Meals</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-emerald-600 mb-2">Guide</h3>
              <p className="text-gray-600 text-sm">
