      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            {/* Amenities */}
            <div className="mb-8">
              <h3 className="text-xl font-bold text-emerald-600 mb-4">Amenities</h3>
            ...
            <div className="bg-emerald-50 rounded-2xl p-6 mb-6 border border-emerald-100">
              <h3 className="text-lg font-bold text-emerald-600 mb-3">Room Rates</h3>
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-gray-700">Standard Room</span>
                  <span className="font-bold text-emerald-600">PKR 8,000/night</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-700">Deluxe Room</span>
                  <span className="font-bold text-emerald-600">PKR 12,000/night</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-700">Suite</span>
                  <span className="font-bold text-emerald-600">PKR 18,000/night</span>
                </div>
              </div>
            </div>

            {/* Book Button */}
            <button className="w-full bg-emerald-600 hover:bg-emerald-700 text-white py-3 rounded-full font-medium transition-colors shadow-lg hover:shadow-xl">
              Book Your Stay
            </button>
          </div>
        </div>
