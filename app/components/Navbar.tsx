      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 pt-0.5 pb-0 sm:pt-1 sm:pb-0">
            ...
            >
              ...
              <div className={`absolute top-full left-0 mt-2 w-52 bg-white rounded-lg shadow-xl py-2 border border-gray-100 transition-all duration-200 ${isDropdownOpen ? 'opacity-100 visible' : 'opacity-0 invisible'}`}>
                ...
                <Link 
                  ...
                  className="block px-5 py-3 text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-red-600 transition-colors"
                >
                 🛣 ️ By Road
                </Link>
              </div>
            ...
            >
              ...
              <div className={`absolute top-full left-0 mt-2 w-64 bg-white rounded-lg shadow-xl py-2 border border-gray-100 transition-all duration-200 ${isPrivateDropdownOpen ? 'opacity-100 visible' : 'opacity-0 invisible'}`}>
                  ...
                  <Link 
                    ...
                    className="block px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-red-600 transition-colors rounded"
                  >
                    ✈️ By Air Tours
                  </Link>
        ...
        <div className={`xl:hidden transition-all duration-300 ease-in-out overflow-hidden ${
          ...
          <div className="py-4 space-y-2 border-t border-white/20">
            <Link 
              href="/" 
              className="block px-4 py-3 text-white hover:bg-white/20 hover:text-red-400 transition-all duration-200 font-semibold rounded-lg text-base"
            ...
            <div>
              <button 
                ...
                className="w-full flex items-center justify-between px-4 py-3 text-white hover:bg-white/20 hover:text-red-400 transition-all duration-200 font-semibold rounded-lg text-base"
              >
                Public Tours
              ...
              <div className={`transition-all duration-200 overflow-hidden ${
                ...
                <Link 
                  href="/public-tours/by-road"
                  className="block pl-8 pr-4 py-3 text-white/90 hover:bg-white/20 hover:text-red-400 transition-all duration-200 rounded-lg"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                   🚗 By Road
                </Link>
            ...
            <div>
              ...
              <div className={`transition-all duration-200 overflow-hidden ${
                isMobilePrivateDropdownOpen ? 'max-h-60 opacity-100' : 'max-h-0 opacity-0'
                  ...
                  <Link 
                    href="/private-tours/by-air"
                    className="block py-2 text-white/90 hover:bg-white/20 hover:text-red-400 transition-all duration-200 rounded-lg px-2"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    ✈️ By Air Tours
                  </Link>
