...
export default function TopBar() {
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-emerald-600/30 backdrop-blur-md text-white py-2 text-base border-b border-white/10">
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex flex-wrap items-center gap-3 xs:gap-4 sm:gap-6">
            ...
            >
              ...
              <span className="lg:hidden text-sm font-medium">Islamabad</span>
            </a>
            ...
            >
              ...
              <span className="sm:hidden text-sm font-medium">Email</span>
            </a>
          ...
          <div className="flex items-center gap-3 xs:gap-4">
            <Link 
              href="/about"
              className="hidden sm:inline text-sm hover:text-emerald-100 transition-colors font-semibold"
            >
              About Us
            </Link>
            <Link 
